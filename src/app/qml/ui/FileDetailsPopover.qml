    ...
    Column {
        ...
        Grid {
            ...
            Label {
                ...
                // with other fields also. A better solution might be possible by using QML5's
                // GridLayout, but I couldn't get it working with the time I haed (with Ubuntu 14.04 desktop).
